namespace DashboardCompanion
{
    ...
    public class LoginCallback : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var token = this.client.ExchangeAuthorizationCodePerAccessToken(context.Request.QueryString["code"], context.Request.Url.ToString());
            var profile = this.client.GetUserInfo(token);
